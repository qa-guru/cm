...
| **Текущий релиз** | **v3.0.5** — [docs/RELEASE_v3.0.5.md](docs/RELEASE_v3.0.5.md) · `qaguru/cm:v3.0.5` |
...
Текущий релиз cm: **v3.0.5** — [release notes](docs/RELEASE_v3.0.5.md).  
Предыдущий: [docs/RELEASE_v3.0.4.md](docs/RELEASE_v3.0.4.md). Docker: `qaguru/cm:v3.0.5`.

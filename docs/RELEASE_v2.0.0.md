...
1. Пишет встроенный `browsers.json` (`qaguru/webdriver-chrome` + `qaguru/playwright-*`) в `/opt/selenoid/`
...
|-------------|-------------------|
| `selenoid/chrome`, `selenoid/firefox` | `qaguru/webdriver-chrome` + `qaguru/playwright-*` |
